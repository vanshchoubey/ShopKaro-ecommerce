          ...
          <Tabs defaultIndex={0} className=" ">
                ...
                <div className="relative overflow-x-auto ">
                  <table className="w-full text-sm text-left text-gray-500 dark:text-gray-400  ">
                    ...
                    {product.map((product, index) => {
                      return (
                        <tbody className="" key={product.id}>
                          <tr
            ...
            <TabPanel>
              ...
              <div className="relative overflow-x-auto mb-16">
                ...
                {
                  order.map((allOrder,name)=>{
                    return  (
                      <table className="w-full text-sm text-left text-gray-500 dark:text-gray-400" key={name}>
                      <thead
                      ...
                      <tbody>
                      {
                        allOrder.cartItems.map((item,i)=>{
                          ...
                          const {title,category,imageUrl,price,date}=item
                            const{name,phoneNumber,pincode,address} =allOrder.addressInfo
                            const {paymentId,email,userid}=allOrder
            ...
            <TabPanel>
              ...
              <div className="relative overflow-x-auto mb-10">
                ...
                <table className="w-full text-sm text-left text-gray-500 dark:text-gray-400">
                 ...
                 {
                  user.map(({name,uid,email,time},i)=>{
                    const date=new Date(time.seconds*1000).toLocaleString("en-US",{
                      month:"short",
                     day:"2-digit",
                     year:"numeric" 
                    })
