...
import logoImage from "../../assets/shopKaro.png"
...
const Navbar = () => {
  ...
  return (
    <div className='bg-white sticky top-0 z-50'>
            ...
            >
              <Dialog.Panel className="relative flex w-full max-w-xs flex-col overflow-y-auto bg-white pb-12 shadow-xl" style={{ backgroundColor: mode === 'dark' ? 'rgb(40, 44, 52)' : '', color: mode === 'dark' ? 'white' : '', }}>
                ...
                <div className="space-y-6 border-t border-gray-200 px-4 py-6">
                  ...
                  {user?.user.email  ==="vanshchoubey100@gmail.com" ?  <div className="flow-root">
                  ...
                  <div className="flow-root">
                    <a className="-m-2 block p-2 font-medium text-gray-900 cursor-pointer" style={{ color: mode === 'dark' ? 'white' : '', }} onClick={logout}>
                      Logout
                    </a>
                  </div>:""}
                  <div className="flow-root">
        ...
        <p className="flex h-10 items-center justify-center  bg-purple-600 px-4 text-sm font-medium text-white sm:px-6 lg:px-8" style={{ backgroundColor: mode === 'dark' ? 'rgb(62 64 66)' : '', color: mode === 'dark' ? 'white' : '', }}>
          Get upto 70% off
        </p>
            ...
            <div className="flex h-16 items-center">
              ...
              <div className="ml-4 flex lg:ml-0">
                <Link to={'/'} className='flex'>
                  <div className="flex ">
                    <h1 className=' text-2xl font-bold text-black  px-2 py-1 rounded' style={{ color: mode === 'dark' ? 'white' : '', }}>shopKaro</h1>
                  </div>
                </Link>
              </div>
              ...
              <div className="ml-auto flex items-center">
               ...
               {   user?<Link to={'/order'} className="text-sm font-medium text-gray-700 " style={{ color: mode === 'dark' ? 'white' : '', }}>
                  ...
                  {user?.user.email  ==="vanshchoubey100@gmail.com" ?  <Link to={'/dashboard'} className="text-sm font-medium text-gray-700 " style={{ color: mode === 'dark' ? 'white' : '', }}>
                    Admin
                  </Link>:""}
